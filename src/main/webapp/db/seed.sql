...
INSERT INTO Users (firstname, lastname, email, role, gender, phone, password, username, profile_image_url, current_address, shipping_address) VALUES
('Shribisha', 'Buddhacharya', 'shribisha@example.com', 'customer', 'female', '9801234567', 'hashed_password', 'shribishab', 'https://example.com/profile/shribisha.jpg', 'Pokhara-17, Nepal', 'Pokhara-15, Nepal'),
('Rajeev', 'Sharma', 'rajeeve@example.com', 'customer', 'male', '9812345678', 'hashed_password', 'rajeeve', 'https://example.com/profile/rajeeve.jpg', 'Kathmandu-10, Nepal', 'Kathmandu-12, Nepal'),
('Anjali', 'Thapa', 'anjali@example.com', 'admin', 'female', '9823456789', 'hashed_password', 'anjaliadmin', 'https://example.com/profile/anjali.jpg', 'Lalitpur-5, Nepal', 'Lalitpur-3, Nepal');
